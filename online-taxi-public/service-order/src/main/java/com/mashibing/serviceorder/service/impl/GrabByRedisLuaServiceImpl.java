...
public class GrabByRedisLuaServiceImpl implements GrabService {
    ...
    public ResponseResult grab(DriverGrabRequest driverGrabRequest) {
        ...
        Boolean existRedisLock = stringRedisTemplate.execute(redisSetScript, strings, "30");
        ...
        if (existRedisLock){
            ...
            Boolean deleteFlag = stringRedisTemplate.execute(redisDelScript, keyArg, value);
